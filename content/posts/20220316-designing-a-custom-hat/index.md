---
date: 2022-03-16
title: 'A guide to designing a custom 3D PVC hat'
template: post
...
Several months ago, I started [Tampa Devs](https://tampadevs.com), a community of software developers in Tampa. Since creating it, I've been exploring creating custom swag. Logos, T-Shirts, stickers, and now a hat.
...
For more finer granularity during the manufacturing process, you can choose to use a tool like [PukkaInc](https://hatcustomizer.pukkainc.com/index.html?refer=return)
...
- Material for each panel _(mesh hats are just 4 panels with meshes)_
...
1. The logo is physically stitched into the fabric during manufacturing
2. The logo is created standalone, and then stitched or heated  onto the fabric
...
I use [affinity designer](https://affinity.serif.com/en-us/), a competitor to adobe illustrator.
...
1. Which outlines work best?
2. Of the outline chosen, what color combinations should be used?
3. How big should the logo be on the hat?
