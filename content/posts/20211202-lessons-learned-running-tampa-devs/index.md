...
me: "okay, sounds good!"
them: "Actually can we postpone it to next month? I had alot of stuff come up"
```
...
Another thing I didn't realize is the fact we needed to have an "intro slide" to mention and shoutout our sponsors. This became a collaborative google slide-effort as well a few days leading up to the event.
...
(3) I'll talk about sponsors and advertising later. 
...
Advertising the evnet on meetup also means we generally have to post it about a month in advance.
