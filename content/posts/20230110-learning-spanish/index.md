---
date: 2023-01-10
title: "Learning Spanish as a Software Developer - Week 1 thoughts"
template: post
thumbnail: "../../thumbnails/writing.png"
slug: learning-spanish-software-developer
categories:
  - Personal
tags:
  - Spanish
...
One goal I have this year is learning Spanish
...
- Spain Spanish
- Latin American Spanish (Mexican, Carribean, etc)
- South American Spanish (Columbian, Venenzulan, etc)
...
```
Watashi no namae wa Vincent desu
```
...
I also went to a ton of tech meetups too. Learning through osmosis this way meant I had a lot of familiriaty of things I did and didn't know, and where I could find more information about "what I didn't know". This also became the basis of topics I choose for [Tampa Devs](https://tampadevs.com) too for tech talks

My favorite go to podcasts while in the car has been [language transfer](https://www.languagetransfer.org/) thus far, since it assumes you have mastery of English and it teaches you how Spanish differs.

## Summary

Additional things I've been learning that have pretty low friction for picking up new things:

- I change the UI layouts to spanish for Google Chrome, and youtube. I already know what each button does based on it's location in the UI. I've picked up words like `vistas` for `views`. It also reminds me that I'm in the phase of learning Spanish
- For foreign films and TV shows on Netflix, there is usually a spanish dub. I watch it on an english dub, and read spanish subtitles. I've been watching "Alice in Borderland" and have picked up a few words this way.
...
- [LingoPie](https://lingopie.com/app/catalog/spanish) - watching kid's cartoon videos in Spanish with english subtitles helps me understand what a basic conversation looks like. There's also a space-repetition learning tool built in here too. These aren't shows I'd traditionally watch, but are mildly entertaining so it's not so bad
- [ITalkI Tutors](https://www.italki.com/) - I intend on paying for some 1:1 tutoring to reinforce actively what I've learned passively. I intend on having multiple tutors. When I used to learn to code, I used the equivalent called [hackhands](https://www.pluralsight.com/hackhands) and found it immensely useful

Things that I am not 100% on how I feel about yet:

- [Anki / Ankidroid](https://apps.ankiweb.net/) - I think space-repetition learning has a place here, but needs to be chunked out over time. It has quickly depreciating value though for me imo, since I prefer drawing an emotional/memorable connection to things I learn. Learning the top 100-200 vocabulary words in Spanish would be useful this way though.
- [DuoLingo](https://www.duolingo.com/) - It's useful but I also find I learn at a significantly slower pace than other tools. Too many animations, button clicks, etc.I also don't care to gamify my learning either this way

Additional learning methods and communities:

- [Meetups](https://www.meetup.com/) - Since I live in Florida, there is bound to meetup groups with local Spanish speakers. I could learn from other beginners too
- Online communities - Reddit, discord, ItalkI Tutors, DuoLingo communities, etc would be a good way to practice written communication and join "Speed Dating/Conversation" zooms.

This has been my general experience learning Spanish and what I think is an effective way of learning, based on my past experiences and what I find an effective way of learning.
