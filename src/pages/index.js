          ...
          <div className="hero-wrapper">
            <div>
              ...
              <p className="hero-description">
                I'm a software developer, community organizer, and former kitchen designer.
                This is my digital garden of notes over the years.
              </p>
              {/* <p className="hero-description">
        ...
        <div className="article-type-wrapper">
          <section className="section-index">
            <Heading
              ...
              slug="/notes"
              buttonText="See All"
              description="Random thoughts, build log archives, and how tos"
            />
