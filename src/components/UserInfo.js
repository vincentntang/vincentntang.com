      ...
      <div className="hero-full">
        <div className="container hero-container">
          ...
          <div className="content-right">
            ...
            <p className="about-user">I'm Vincent Tang, a software engineer specialized in product manufacturing. This website is my public notes of random shower thoughts, life lessons learned, and technical domains of interest. I'm the founder of <a target="_blank" rel="noreferrer" href="https://tampadevs.com">Tampa Devs</a> and I also run a coding podcast called <a target="_blank" rel="noreferrer" href="https://codechefs.dev">Code Chefs</a></p>
