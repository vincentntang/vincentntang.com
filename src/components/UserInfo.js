      ...
      <div className="hero-full">
        <div className="container hero-container">
          ...
          <div className="content-right">
            ...
            <p className="about-user">I'm Vincent Tang, a software engineer specialized in product design and manufacturing. I [learn without boundaries](https://www.vincentntang.com/learn-without-boundaries/), and write about lessons I've learned. From engineering, to manufacturing, to leadership, and soft science fields. I'm the founder of <a target="_blank" rel="noreferrer" href="https://tampadevs.com">Tampa Devs</a> and I also run a coding podcast called <a target="_blank" rel="noreferrer" href="https://codechefs.dev">Code Chefs</a></p>
