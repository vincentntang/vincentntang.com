      ...
      <div className="hero-full">
        <div className="container hero-container">
          ...
          <div className="content-right">
            ...
            <p className="about-user">I'm Vincent Tang, a software engineer specialized in product design and manufacturing. Originally this website started as a coding blog, then lessons about leadership, and now things I find interesting and build logs of my own creations. I'm the founder of <a target="_blank" rel="noreferrer" href="https://tampadevs.com">Tampa Devs</a> and I also run a coding podcast called <a target="_blank" rel="noreferrer" href="https://codechefs.dev">Code Chefs</a></p>
