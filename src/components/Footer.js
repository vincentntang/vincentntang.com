...
const links = [
  ...
  { url: 'https://vincentntang.app/profile/vincentntang', label: 'Bluesky' },
  // { url: 'https://ko-fi.com/vincentntang', label: 'Buy me a coffee' },
]
const madeWithLinks = [
  { url: 'https://www.gatsbyjs.org', label: 'Gatsby', icon: gatsby },
  { url: 'https://github.com/vincentntang', label: 'GitHub', icon: github },
  ...
  return (
    <footer className="footer">
      <section className="footer-section">
        ...
        <div className="footer-made-by">Made with GatsbyJS</div>
      </section>
    </footer>
  )
}
